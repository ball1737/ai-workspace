...
2026-05-06T15:30:00+0700 | lead-20260506-1100-r1 | lead | task.completed | Phase 3 Features UI relocated — /dashboard/client-management/[uuid] tab removed (commented for revert); embedded in /dashboard/package-config?from=customer&companyId={UUID} replacing legacy config-feature section under USE_LEGACY_CONFIG_FEATURE flag; commit eabc560 pushed
2026-05-06T16:00:00+0700 | lead-20260506-1100-r1 | lead | task.completed | Phase 3 toggle behavior refactor — (1) removeOverride → archive (status_type=INACTIVE) for audit trail; (2) setOverride detects matches-default → archive instead of redundant upsert; (3) resolver getCompanyOverridesRepository confirmed filters ccf.status_type=ACTIVE; 77/77 unit+integration PASS (added TC-13b/13c match-default cases); commit 07ea4edc pushed
2026-05-06T16:30:00+0700 | lead-20260506-1100-r1 | lead | task.completed | Override INSERT-always + ARCHIVED status — (1) M9 migration: drop UNIQUE, create partial UNIQUE WHERE status_type='active' (allows archived audit rows + 1 active per pair); (2) replaceActiveOverrideRepository in trx (archive existing + insert new) replaces upsertOverrideRepository; (3) archive uses ARCHIVED='archived' (not INACTIVE); (4) catches PG 23505 → 409. 78/78 PASS. Commit 8c07ef3e pushed. Pending: run `pnpm db:migrate:latest` on dev DB before deploy.
2026-05-06T17:00:00+0700 | lead-20260506-1100-r1 | lead | dispatch.queued | Phase 4 dispatch start (Resolver Integration + Regression) — wave breakdown W1 external/auth, W2 admin compPermission, W3 audit, W4 regression tests
2026-05-06T17:15:00+0700 | developer-subagent | developer | task.completed | Phase 4 W1 done — getPermissionsService extended (added permission field via resolveUserEffectivePermissionService); per-request cache; PERMISSION_DATA_NOT_FOUND graceful {}; backward compat (additive)
2026-05-06T17:30:00+0700 | developer-subagent | developer | task.completed | Phase 4 W2 done — getCompPermissionByUuidService filter; createCompPermissionService + updateCompPermissionByUuidService validate save JSONB keys against company effective menus (P4.4 reject 400 INVALID_MENU_KEY_FOR_COMPANY); extractMenuKeysFromPermissionJsonbService helper added in resolver; flagged deepMerge open question for F4.1
2026-05-06T17:45:00+0700 | developer-subagent | developer | task.completed | Phase 4 W3 audit done (read-only) — found 4 missing filter points: /auth/user-info hot path (getEmployeePermissionService), getCompPermissionByUuidController deepMerge bypass, /comp-permission/default unfiltered, owner case (isOwner=true bypass). Report at f4-1-frontend-audit.md. Lead resolved Q-A=STRICT / Q-B=companyUuid optional / Q-C=no migration
2026-05-06T18:00:00+0700 | developer-subagent | developer | task.completed | Phase 4 W3.5 audit-fix wave done — Fix 1 getEmployeePermissionService filter (PermissionDefault baseline + JSONB pre-merge + post-merge second pass for Q-C); Fix 2 getCompPermissionByUuidController baseline filter; Fix 3 /comp-permission/default optional companyUuid query; Fix 4 owner STRICT transitively
2026-05-06T18:15:00+0700 | qa-subagent | qa | task.completed | Phase 4 W4 done — 25/25 integration tests PASS (IT-A→IT-L); sibling Phase 3 17/17 still green; flagged DEF-001 (pre-existing W1 stale unit test)
2026-05-06T18:30:00+0700 | code-reviewer-subagent | code-reviewer | task.completed | Phase 4 CR done — PASS-with-fixes (0 crit / 2H / 2M / 3L); BLOCKED until H1 (double resolver call) + H2 (DEF-001 stale unit test); report cr-phase4.md
2026-05-06T18:45:00+0700 | developer-subagent | developer | task.completed | Phase 4 CR Fix Wave done — 6/7 fixes (H1 cache sharing service↔controller; H2 unit test resolver mock 5/5 PASS; M1 early-return ก่อน resolver call; M2 single DB lookup; L1 logger TODO; L2 z.any→z.unknown × 6); L3 deferred. 47/47 tests PASS
2026-05-06T19:00:00+0700 | ba-subagent | ba | task.completed | Phase 4 BA validation done — PASS-with-notes (0 crit / 3 non-crit defer-able); FR coverage ครบ; Q-A/B/C verified; CR fixes verified; report ba-validation-phase4.md
2026-05-06T19:15:00+0700 | lead-20260506-1100-r1 | lead | task.completed | Phase 4 push — hw-be commit bffc2dbf → origin/ball/feature/feature-management; Phase 4 closed; Phase 5 (cleanup) เก็บไว้ทำหลัง deploy stable
2026-05-06T19:30:00+0700 | lead-20260506-1100-r1 | lead | dispatch.queued | Phase 5 (Mobile Menu Parity) plan approved — 11 waves; Q1-Q8 decisions resolved; SEED tier mapping confirmed
2026-05-06T20:00:00+0700 | developer-subagent | developer | task.completed | Phase 5 W1 done — M9 ALTER + GIN; M10 backfill SEED 4 features; CompFeatures model + jsonAttributes; getAvailableMobileMenuKeys (parameterized walker shared with web)
2026-05-06T20:30:00+0700 | developer-subagent | developer | task.completed | Phase 5 W2 done — Feature CRUD pass-through mobileMenuKeys; validateMobileMenuKeys 400 INVALID_MOBILE_MENU_KEY; /menu-keys/available BREAKING {web,mobile}
2026-05-06T21:00:00+0700 | developer-subagent | developer | task.completed | Phase 5 W3 done — resolver mobile path: getFeatureMobileMenuKeysRepository + 3 service fns; cache key mobileMenuKeys:{companyId}; walker delegate to web
2026-05-06T21:30:00+0700 | developer-subagent | developer | task.completed | Phase 5 W4 done — external auth + user-info filter mobile; permissionMobile field; getUserPermissionJsonbRepository extended select permission_mobile (1 hop); 7/7 unit tests PASS
2026-05-06T22:00:00+0700 | developer-subagent | developer | task.completed | Phase 5 W5 done — Phase 4 W2 BUG fix: split web/mobile validation; INVALID_MOBILE_MENU_KEY_FOR_COMPANY 400; controller filter PermissionMobileDefault baseline mirror; owner Q-A=STRICT enforced
2026-05-06T22:30:00+0700 | developer-subagent | developer | task.completed | Phase 5 W6 done — FE Feature.mobileMenuKeys; AvailableMenuKeysPayload {web,mobile} BREAKING; reducer + 4 bridge sites for W7+W8 cleanup
2026-05-06T23:00:00+0700 | developer-subagent | developer | task.completed | Phase 5 W7 done — discriminated union components mode 'single'|'split'; feature-form Web col + Mobile col; i18n parity 64/64 featureManagement.*
2026-05-06T23:30:00+0700 | developer-subagent | developer | task.completed | Phase 5 W8 done — companyFeature endpoint envelope {list, effectiveMenuKeys, effectiveMobileMenuKeys}; new company-effective-menus-preview component; per-row chips; i18n parity 42/42 companyFeatures.*
2026-05-07T00:00:00+0700 | qa-subagent | qa | task.completed | Phase 5 W9 done — 135/135 PASS (Q8=B describe.each parameterized; W5 BUG regression test verified false-pass scenario rejected)
2026-05-07T00:30:00+0700 | code-reviewer-subagent | code-reviewer | task.completed | Phase 5 W10 CR done — PASS-with-fixes (0 crit / 1H / 3M / 3L); BLOCKED until H1 (double getUserPermissionJsonbRepository call in hot path); report cr-phase5.md
2026-05-07T01:00:00+0700 | developer-subagent | developer | task.completed | Phase 5 CR Fix Wave done — 5/7 (H1 userPermissionJsonb cache; M1 buildCompanyFeatureList cache; M2 M10 Promise.all; L2 isCustomHttpError); skip M3+L1+L3 deferred; 205 tests PASS
2026-05-07T01:30:00+0700 | ba-subagent | ba | task.completed | Phase 5 BA validation done — PASS-with-notes (0 crit / 4 non-crit); FR-Mobile-1..7 ครบ; Q1-Q8 verified; H1+M1+M2+L2 fixes verified; Phase 4 W2 BUG fix regression test verified
2026-05-07T01:45:00+0700 | lead-20260506-1100-r1 | lead | task.completed | Phase 5 push — hw-be commits fdb79869+467b395d + hw-sale-cms commit 3676e46 → origin/ball/feature/feature-management; Phase 5 closed; ⚠ M9+M10 migration ต้องรันบน dev DB ก่อน deploy
